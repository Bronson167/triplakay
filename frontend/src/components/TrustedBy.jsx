  ...
  return (
    <motion.div
     ...
     className='flex flex-col items-center px-4 sm:px-12 lg:px-24 xl:px-40 gap-10 text-gray-700 dark:text-white/80'>
      ...
      viewport={{once: true}}
       className='font-semibold'>Des entreprises et organisations qui nous font confiance</motion.h3>
      ...
      className='flex items-center justify-center flex-wrap gap-10 m-4'>
        {company_logos.map((logo, index) => (
            ...
            key={index} src={logo} className='max-h-50 sm:max-h-40 dark:drop-shadow-xl' alt="" />
        ))}
      </motion.div>
    </motion.div>
  )
